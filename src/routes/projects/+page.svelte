<script lang="ts">
	...
	const projects = [
		...
		},
		{
			...
			link: { href: '#', label: 'github.com' },
			logo: '/logos/open-shuttle.svg'
		}
	];
</script>

<svelte:head>
	<title>Projects - Félix Defrance</title>
